...
- Authored enterprise architecture documentation including ADRs, Systems Architecture Specifications ([SAS](https://github.com/rdbumstead/salesforce-platform-architect-portfolio/blob/main/docs/guides/03-SAS.md)), and [Program Charters](https://github.com/rdbumstead/salesforce-platform-architect-portfolio/blob/main/docs/guides/02-Program-Charter.md).
